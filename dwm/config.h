...
/* tagging */
static const char *tags[] = { "", "", "", "", "", "省", "恶", "露", "督" };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_i,      spawn,          SHCMD("exec ~/Applications/idea/idea-IU-241.15989.150/bin/idea.sh") },
        { MODKEY,                       XK_c,      spawn,          SHCMD("exec maim -s ~/Documents/personal/roam/img/$(date +%H:%M:%S).png") },
        { MODKEY,                       XK_o,      spawn,          SHCMD("exec maim ~/$(date +%H:%M:%S).png") },
        { MODKEY,                       XK_e,      spawn,          SHCMD("exec emacs") },
        { MODKEY,                       XK_w,      spawn,          SHCMD("exec brave") },
        { MODKEY,                       XK_n,      spawn,          SHCMD("exec nemo") },
        { 0,                            XF86XK_AudioRaiseVolume,     spawn,          {.v = upvol   } },
        { 0,                            XF86XK_AudioLowerVolume,     spawn,          {.v = downvol } },
        { 0,                            XF86XK_AudioMute,     spawn,          {.v = mutevol } },
        { 0,                            XF86XK_MonBrightnessDown,   spawn,          {.v = light_up } },
        { 0,                            XF86XK_MonBrightnessUp,     spawn,          {.v = light_down } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
